...
public class AuthorizationCodeByHeaderTest {
	...
	private static final String HTTP_HEADER_AUTHORIZATION = "Basic dGVzdF9jbGllbnRfaWRfMTp0ZXN0X2NsaWVudF9zZWNyZXRfMQ==";
	...
	public void c_token() {
		RequestBuilder request = MockMvcRequestBuilders
			.post("/oauth/token")
			.header("Authorization", HTTP_HEADER_AUTHORIZATION)
